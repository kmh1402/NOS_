#if !defined(AFX_CTLIST_H__130962AF_1524_47A6_9DC8_316E7C9808C9__INCLUDED_)
#define AFX_CTLIST_H__130962AF_1524_47A6_9DC8_316E7C9808C9__INCLUDED_
...
public:
	CLSID const& GetClsid()
	{
		static CLSID const clsid
			= { 0x47ff24a9, 0xac60, 0x4cf3, { 0xb1, 0xf5, 0x80, 0xbe, 0xed, 0xb5, 0x7, 0xc9 } };
		return clsid;
	}
...
public:
	...
	long GetTopRow();
	void SetTopRow(long);
	BOOL GetSubTextNodes();
	void SetSubTextNodes(BOOL);
	unsigned long GetTitleBackColorTo();
	void SetTitleBackColorTo(unsigned long);
	long GetTitleFillType();
	void SetTitleFillType(long);
	unsigned long GetHeaderBackColorTo();
	void SetHeaderBackColorTo(unsigned long);
	long GetHeaderFillType();
	void SetHeaderFillType(long);
	unsigned long GetPreColumnBackColorTo();
	void SetPreColumnBackColorTo(unsigned long);
	long GetPreColumnFillType();
	void SetPreColumnFillType(long);
	unsigned long GetBackColorTo();
	void SetBackColorTo(unsigned long);
	long GetBackFillType();
	void SetBackFillType(long);
	long GetNodeType();
	void SetNodeType(long);
...
public:
	...
	BOOL GetListSubVisible(long nIndex);
	void SetListSubVisible(long nIndex, BOOL bNewValue);
	short GetColumnHeaderAlign(short nColumn);
	void SetColumnHeaderAlign(short nColumn, short nNewValue);
	void AboutBox();
};
...
#endif // !defined(AFX_CTLIST_H__130962AF_1524_47A6_9DC8_316E7C9808C9__INCLUDED_)
